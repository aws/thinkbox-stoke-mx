...
"""
Generate Version Files for StokeMX
"""
...
BEGIN
	...
	BEGIN
		BLOCK "040904b0"
		BEGIN
			VALUE "Comments", "Thinkbox StokeMX"
			VALUE "CompanyName", "Thinkbox Software"
			VALUE "FileDescription", "StokeMX Dynamic Link Library"
			VALUE "FileVersion", "{major}.{minor}.{patch}"
			VALUE "InternalName", "StokeMX"
			VALUE "LegalCopyright", "Copyright (C) 2022"
			VALUE "OriginalFilename", "MaxStoke.dlo"
			VALUE "ProductName", "StokeMX"
...
#define FRANTIC_DESCRIPTION "Thinkbox Stoke for 3ds Max"
"""

def write_version_header(version: str, filename: str='StokeMXVersion.h') -> None:
    """
...
def write_version_resource(version: str, filename: str='StokeMXVersion.rc') -> None:
    """
